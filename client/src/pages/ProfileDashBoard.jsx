...
const ProfileDashBoard = () => {
  ...
  return (
    <div className="flex justify-center items-center p-4">
      ...
      <Card 
        className="w-full max-w-md shadow-xl rounded-2xl p-2 !bg-[#1e293b] !border-slate-700/50"
      >
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/30">
              ...
              <p className="text-slate-200 text-sm font-medium">{user?.name || "Member"}</p>
            </div>

            <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/30">
              <p className="text-slate-500 text-[10px] uppercase font-bold tracking-wider mb-1">Email Address</p>
              <p className="text-slate-200 text-sm font-medium">{user?.email}</p>
            </div>

            <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/30">
              <p className="text-slate-500 text-[10px] uppercase font-bold tracking-wider mb-1">Account Role</p>
